...
export function findPassenger(passengers, name) {
  ...
  return pass.name.toLowerCase() === name.toLowerCase()
  })
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex((index)=>{
    return index.name.toLowerCase() === name.toLowerCase() 
  })
...
export function isAnyWaitlisted(passengers) {
  ...
  return passengers.some((pass)=>{
    return pass.status === "waitlisted"
  })
}
...
export function areAllConfirmed(passengers) {
  ...
  return passengers.every((pass)=>{
   return pass.status === "confirmed"
  })
}
